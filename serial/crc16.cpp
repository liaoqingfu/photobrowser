...
quint16 checksum(QByteArray data)
{
    ...
    quint16 i; /* will index into CRC lookup */
    ...
    result = ( ((quint16) crc_hi & 0x0ff) << 8 ) | ( (quint16) crc_lo & 0x0ff );
    //result = ( ((quint16) crc_lo & 0x0ff) << 8 ) | ( (quint16) crc_hi & 0x0ff );
...
{
   QString ret = QString::number(num,16);
